(function(){
    ...
    class Select{
        ...
        init(){
            this.clearHtml();
            this.parent.addEventListener("change",this.change.bind(this));
            this.change();
        }
        ...
        change(){
            ...
            if(this.dataId < json.length - 1){
                let parentNode = document.getElementsByClassName("sel")[this.dataId + 1];
                // init(this.dataId+ 1, parentNode);
                return new Select(this.dataId + 1, parentNode);
